...
PROTOBUF_NAMESPACE_OPEN
template <>
::ReqSignup *Arena::CreateMaybeMessage<::ReqSignup>(Arena *);
template <>
::RespSignup *Arena::CreateMaybeMessage<::RespSignup>(Arena *);
PROTOBUF_NAMESPACE_CLOSE

// ===================================================================

class ReqSignup final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ReqSignup) */
{
public:
...
class RespSignup final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:RespSignup) */
{
public:
...
inline PROTOBUF_ALWAYS_INLINE void ReqSignup::set_username(ArgT0 &&arg0, ArgT... args)
{
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE void ReqSignup::set_password(ArgT0 &&arg0, ArgT... args)
{
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE void RespSignup::set_msg(ArgT0 &&arg0, ArgT... args)
{
